    ...
    def run(self):
        ...
        if mss is None:
            ...
            self.error_captura.emit(
                "La librería MSS no está instalada."
            )
...
class BIN(QMainWindow):
    ...
    def crear_interfaz(
        ...
        self.visor_imagen.setObjectName(
            "visorImagen"
        )

        self.visor_imagen.setAlignment(
            Qt.AlignCenter
        )
        ...
        self.visor_imagen.setScaledContents(
            False
        )
        ...
        self.mensaje_visor.setWordWrap(
            True
        )

        self.mensaje_visor.setMaximumHeight(
            70
        )
    ...
    def excluir_bin_de_captura(self):
        ...
        try:
            ...
            if hasattr(
                ...
                self.mensaje_chat.setText(
                    "BIN: Windows no permitió excluir "
    ...
    def iniciar_captura_pantalla(self):
        ...
        if (
            self.hilo_captura
            and self.hilo_captura.isRunning()
        ):
        ...
        self.hilo_captura.frame_ready.connect(
            self.recibir_frame_pantalla
        )

        self.hilo_captura.error_captura.connect(
            self.mostrar_error_captura
        )
