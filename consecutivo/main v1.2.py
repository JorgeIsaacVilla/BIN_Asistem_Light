...
class VisorInteractivo(QLabel):
    ...
    punto_solicitado = Signal(float, float)
    ...
    def mousePressEvent(self, event):
        ...
        # ----------------------------------------------------
        # El pixmap se muestra con KeepAspectRatio.
        #
        # Por eso puede haber bandas vacías arriba/abajo
        # o a los lados.
        #
        # Primero calculamos dónde empieza realmente
        # la imagen dentro del QLabel.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # IGNORAR CLICS SOBRE LAS BANDAS VACÍAS
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # CONVERTIR A COORDENADA NORMALIZADA 0.0 - 1.0
        # ----------------------------------------------------
...
class BIN(QMainWindow):
    ...
    def crear_interfaz(self):
        ...
        titulo_visor = QLabel("Visor de IA")
    ...
    def enviar_click_real(
        ...
        estilo_original = None

        try:

            # ------------------------------------------------
            # Guardamos el estilo actual de BIN.
            # ------------------------------------------------
            ...
            # ------------------------------------------------
            # Durante unos instantes hacemos que BIN sea
            # transparente para el clic.
            #
            # De esta forma el clic inyectado atraviesa la
            # ventana de BIN y llega al escritorio o programa
            # que estamos viendo debajo.
            # ------------------------------------------------
            ...
            # ------------------------------------------------
            # BIN vuelve inmediatamente a recibir el mouse.
            # ------------------------------------------------

            if estilo_original is not None:
    ...
    # ========================================================
    # MOVER CURSOR DESDE EL VISOR
    # ========================================================

    # ========================================================
    # INTERACTUAR CON WINDOWS DESDE EL VISOR
    # ========================================================
    ...
    def mover_cursor_desde_visor(
        ...
        # ----------------------------------------------------
        # EL VISOR SOLO CONTROLA WINDOWS DURANTE
        # MOSTRAR RUTINA
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # REGISTRAR LO QUE ACABA DE HACER EL USUARIO
        # ----------------------------------------------------
        ...
        self.actualizar_chat_bin(
            "Acción capturada.\n\n"
            f"{numero_accion:02}. Clic izquierdo\n"
            f"X={x_real} · Y={y_real}"
        )
    # ========================================================
