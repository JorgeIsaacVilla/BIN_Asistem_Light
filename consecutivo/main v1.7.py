    ...
    def permitir_bin_en_capturas(self):
        ...
        try:
            ...
            if hasattr(
                ...
                self.mensaje_chat.setText(
                    "BIN: Windows no pudo modificar "
                    "la configuración de captura."
                )
    ...
    def recibir_frame_pantalla(
        ...
        if sys.platform == "win32":
            ...
            try:
                ...
                # Si BIN es la ventana que el usuario está viendo,
                # no aceptamos nuevos frames del escritorio.
                #
                # Así evitamos:
                #
                # BIN -> captura BIN -> captura BIN -> infinito.
                #
                # El último frame externo válido queda congelado
                # en el Visor IA.
                if hwnd_foreground == hwnd_bin:
                    return
